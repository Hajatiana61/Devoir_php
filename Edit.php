...
/*--------------------------------------------------------------*/
            ...
            for($tmp = 0; $tmp < $number; $tmp++)
            {
                ...
                if($tmp == $modify)
                {
                    ...
                    echo "<input type=\"hidden\" id=\"l\" name=\"line\" value=$tmp>";

                    $requet[$tmp] = "<tr bgcolor=$color>".
                                        "<td align=middle width=\"150px\">".

                                        "<label for=\"Edit_A\"></label>".
                                        "<input type=\"number\" id=\"a\" name=\"Edit_A\" required>"

                                        ."</td>
                                        <td align=middle width=\"150px\">".

                                         "<label for=\"Edit_A\"></label>".
                                        "<input type=\"number\" id=\"b\" name=\"Edit_B\" required>"
